...
#define STRING_CONFIG_H_AUTHOR "(GreenXav, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3-BTT-miniE3-v1.2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -1.25 }
